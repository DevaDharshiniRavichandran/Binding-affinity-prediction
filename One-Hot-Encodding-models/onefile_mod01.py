...
def train_model(epi_embeddings, tcr_embeddings, binding):
    ...
    checkpoint_filepath = 'tcr01_modified_model_checkpoint.weights.h5'
    ...
    csv_logger = CSVLogger('TCR01_mod_training_history.csv', append=False)
    ...
    model.save('tcr01_modified_model.h5')
    ...
    with open('TCR01_mod_validation_performance.txt', 'w') as f:
